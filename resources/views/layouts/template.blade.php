            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a href="{{ url('lahan') }}" class="waves-effect waves-dark"  aria-expanded="false">
                                <i class="mdi mdi-home"></i><span class="hide-menu">Lahan </span>
                            </a>
                        </li>
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('parkiranku') }}">Input Parkir</a></li>
                                <li><a href="{{ url('parkiranku/dataparkir') }}">Data Parkir</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
